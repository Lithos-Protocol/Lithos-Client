...
object BlockReducer {
  ...
  /** Applies one dictionary transform without advancing a block cursor, for bootstrap replay. */
   ...
   * Digest checks determine correctness; proof bytes may differ across valid implementations.
   */
