...
object Contexts {
  ...
  final val CandidateIo: String = "candidate-io-dispatcher"
  final val MiningControlIo: String = "mining-control-io-dispatcher"
  final val Genesis: String = "genesis-dispatcher"
