import actors.{BlockReceiver, SyncCoordinator, TreeSyncer}
...
class Module(environment: Environment, configuration: Configuration) extends AbstractModule with AkkaGuiceSupport
{
  ...
  override def configure(): Unit = {
    ...
    bindActor(classOf[BlockReceiver], "block-receiver", p => p.withDispatcher("lithos-contexts.sync-dispatcher"))
